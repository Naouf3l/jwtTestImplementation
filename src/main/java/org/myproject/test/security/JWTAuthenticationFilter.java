...
import static org.myproject.test.security.SecurityConstants.*;
...
//        setRequiresAuthenticationRequestMatcher(new AntPathRequestMatcher(LOGIN_URL, "POST"));
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        String token = Jwts.builder()
                ...
                .compact();
        String username = ((User) auth.getPrincipal()).getLogin();

        res.addHeader(HEADER_STRING, TOKEN_PREFIX + " " + SecurityConstants.generateToken(username));
